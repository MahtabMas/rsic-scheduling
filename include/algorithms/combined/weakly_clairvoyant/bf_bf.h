...
class BestFit_BestFit {
public:
    BestFit_dimensional FFShort, FFLong;  // Two separate BestFit instances
    ...
    BestFit_BestFit(const std::vector<int64_t>& _capacity, int64_t _threshold): capacity(_capacity), threshold(_threshold), FFShort(_capacity), FFLong(_capacity) {}
