...
class FirstFit_FirstFit {
public:
    FirstFit_dimensional FFShort, FFLong;  // Two separate FirstFit instances
    ...
    FirstFit_FirstFit(const std::vector<int64_t>& _capacity, int64_t _threshold): capacity(_capacity), threshold(_threshold), FFShort(_capacity), FFLong(_capacity) {}
